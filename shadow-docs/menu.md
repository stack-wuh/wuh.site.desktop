...
| 技术域 | 关键词 | 应查阅 |
|--------|--------|--------|
| 渲染层导航/壳层 | 页面 面板 视图 路由 设置 全屏 弹窗 导航 ActivityBar 侧栏 tab | knowledge/renderer-shell-routing.md |
| 壳层 chrome / 图标 | 图标 图标注册表 AppIcon Icon StatusBar 状态栏 徽标 tooltip 描边 主题 token | knowledge/shell-chrome-design.md |
